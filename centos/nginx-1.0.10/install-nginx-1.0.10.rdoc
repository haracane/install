...
https://github.com/haracane/install/tree/master/centos/nginx-1.0.10
= 起動スクリプト作成
...
- {conf.d/proxy.conf}[https://github.com/haracane/install/centos/nginx-1.0.10/conf/conf.d/proxy.conf]
- {conf.d/proxy_ssl.conf}[https://github.com/haracane/install/centos/nginx-1.0.10/conf/conf.d/proxy_ssl.conf]
- {conf.d/proxy_cache.conf}[https://github.com/haracane/install/centos/nginx-1.0.10/conf/conf.d/proxy_cache.conf]
- {conf.d/unicorn.conf}[https://github.com/haracane/install/centos/nginx-1.0.10/conf/conf.d/unicorn.conf]
- {conf.d/passenger.conf}[https://github.com/haracane/install/centos/nginx-1.0.10/conf/conf.d/passenger.conf]
