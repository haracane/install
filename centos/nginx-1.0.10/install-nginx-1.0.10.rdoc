...
* conf.d/
  * {proxy.conf}[https://github.com/haracane/install/blob/centos/nginx-1.0.10/conf/conf.d/proxy.conf]
  * {proxy_ssl.conf}[https://github.com/haracane/install/blob/centos/nginx-1.0.10/conf/conf.d/proxy_ssl.conf]
  * {proxy_cache.conf}[https://github.com/haracane/install/blob/centos/nginx-1.0.10/conf/conf.d/proxy_cache.conf]
  * {unicorn.conf}[https://github.com/haracane/install/blob/centos/nginx-1.0.10/conf/conf.d/unicorn.conf]
  * {passenger.conf}[https://github.com/haracane/install/blob/centos/nginx-1.0.10/conf/conf.d/passenger.conf]
